    ...
    for node_id in range(wafer.num_nodes):
        ...
        for row in data:
            ...
            if row["operation"] == "Linear":
                ...
                dims = (M, K, N)
                LinearLayer(layer_uid, node_id, dims, wafer, prec)
                ...
                dims = (B, M, K, N)
                GroupedLinearLayer(layer_uid, node_id, dims, wafer, prec)
                ...
                MLALayer(layer_id, node_id, q_dims, kv_dims, pe_dims, wafer, prec)
                ...
                MulticastLayer(layer_id, node_id, dst_nodes, dims, wafer, prec)
                ...
                UnicastLayer(layer_id, node_id, dst_node, dims, wafer, prec)
                ...
                AllreduceLayer(layer_id, node_id, comm_group, dims, wafer, prec)
