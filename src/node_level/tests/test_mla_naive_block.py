...
def test_mla_naive_block(bsz, seqlen, dp_attn, tp_attn, sp):
    reset_compute_graph()
    ...
    for rank in range(num_nodes):
        ...
        ops[rank] = MLANaiveBlock(
            uid=f"{rank}:mlanaiveblock_0", 
...
if __name__=="__main__":
    test_mla_naive_block(64, 128, 4, 4, 4)